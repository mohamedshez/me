...
export function ContactSection() {
  return <section className="contact-section"><div className="site-container"><span className="eyebrow">LET’S CONNECT</span><h2>Good work starts<br />with a conversation<span>.</span></h2><div className="actions"><a className="button primary" href={`mailto:${person.email}`}>Say hello <ArrowUpRight size={18} /></a><ExternalLink href={person.linkedin}>LinkedIn</ExternalLink><Link className="text-link" href="/about">More about me <ArrowRight size={16} /></Link></div></div></section>;
}
